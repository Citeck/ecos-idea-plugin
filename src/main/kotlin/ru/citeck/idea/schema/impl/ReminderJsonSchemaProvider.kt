...
class ReminderJsonSchemaProvider(private val project: Project) : JsonSchemaFileProvider {

    override fun isAvailable(file: VirtualFile): Boolean {
        val meta = ArtifactsService.getInstance().getArtifactInfo(file, project) ?: return false
        return meta.getTypeId() == "notification/reminder"
    }

    override fun getName(): String = "Citeck Reminder Schema"

    override fun getSchemaFile(): VirtualFile? {
        return JsonSchemaProviderFactory.getResourceFile(
            ReminderJsonSchemaProvider::class.java,
            "/citeck/artifacts/notification/reminder/reminder-schema.json"
        )
    }
