...
public class EcosModuleWizardStep extends ModuleWizardStep {
    ...
    private final CiteckModuleBuilder builder;
    ...
    private final JBList<CiteckMavenArchetype> archetypesList = createArchetypesList();

    public EcosModuleWizardStep(CiteckModuleBuilder builder) {
        this.builder = builder;
    }

    private JBList<CiteckMavenArchetype> createArchetypesList() {
        JBList<CiteckMavenArchetype> archetypesList = new JBList<>(CiteckMavenArchetype.EP_NAME.getExtensionList());
